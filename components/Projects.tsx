  ...
  const fetchProjects = async () => {
    try {
      ...
      const url = selectedTech
        ? `/api/projects?tech=${encodeURIComponent(selectedTech)}`
        : '/api/projects';
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {loading ? (
          ...
          <div className="text-center py-12 text-gray-600 dark:text-gray-400">
            No projects found. Add the &apos;portfolio&apos; topic to your GitHub repos to display them here.
          </div>
        ) : (
                ...
                <div className="flex flex-wrap gap-2 mb-4">
                  {project.topics.map((tech) => (
                    <span
                      ...
                      className="px-3 py-1 bg-gray-100 dark:bg-gray-800 text-gray-700 dark:text-gray-300 text-sm rounded-full cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-700 transition"
                    >
                      {tech}
                    </span>
                  ))}
